...
function ODSSection() {
  ...
  return (
    <div className="ODSContainer">
      <h1 class="place-self-center font-extrabold text-6xl bg">
        Ajudamos empresas a atingir suas metas da ODS da ONU
      </h1>
      <div class="grid grid-flow-col justify-center gap-20">
        <img src={ODS1} width="350" alt="logo" />
        <img src={ODS4} width="350" alt="logo" />
        <img src={ODS5} width="350" alt="logo" />
        <img src={ODS10} width="350" alt="logo" />
      </div>
    </div>
  );
}
